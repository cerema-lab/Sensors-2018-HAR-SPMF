...
# DenseNet for image recognition on KARD dataset - Action Set 2.
...
train_data_dir = 'data/Activity Set 2/train'
validation_data_dir = 'data/Activity Set 2/validation'
...
# Saving weight.
model.save_weights('output/KARD/Set2/DenseNet-190-40-KARD-Set2.h5')

from datetime import datetime
start=datetime.now()

datagen = ImageDataGenerator(rescale = 1./255)
generator = datagen.flow_from_directory('data/Activity Set 2/validation',
                                        target_size=(32, 32),
                                        batch_size=1,
...
plt.figure()
plot_confusion_matrix(cnf_matrix, classes =['Bend', 'Catch Cap', 'Draw Tick', 'Forward Kick', 'Hand Clap', 'High Arm Wave', 'Side Kick', 'Sit Down'], normalize=True,
                      title='Confusion Matrix on KARD/Set2')

plt.savefig('output/KARD/Set2/Confusion-Matrix-DenseNet-190-40-KARD-Set2.png')
...
plt.title('DenseNet (L=190, k=40) on KARD/Action Set 2',fontsize=10, fontweight='bold',color = 'Gray')
...
# Save the figure.
plt.savefig('output/KARD/Set2/DenseNet-190-40-KARD-Set2.png')
plt.show()
