...
train_data_dir = 'data/AS1/train'
validation_data_dir = 'data/AS1/validation'
nb_train_samples = 3252
...
if K.image_data_format() == 'channels_first':
    ...
    model = densenet.DenseNet(nb_classes,                       # Number of classes: 8 for MSR Action3D and 60 for NTU-RGB+D.
                              ...
                              94,				# Depth: int -- how many layers; "Depth must be 3*N + 4"
...
generator = datagen.flow_from_directory('data/AS1/validation',
                                        target_size=(32, 32),
                                        batch_size=1,
...
test_acc = 'Test Accuracy, max = ' + str(98.29) +' (%)'
...
plt.title('DenseNet (L=100, k=12) on Enhanced-SPMFs of MSR Action3D/AS1',fontsize=10, fontweight='bold',color = 'Gray')
...
plt.ylabel('Training on Data without Rotated Images',fontsize=10, fontweight='bold',color = 'Gray')
plt.legend()

# Save the figure.
plt.savefig('output/AS1/DenseNet-250-24-MSR-Action3D-AS1-SPMF.png')
plt.show()
