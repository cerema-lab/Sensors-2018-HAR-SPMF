...
# DenseNet for image recognition on KARD dataset.
...
train_data_dir = 'data/Activity Set 1/train'
validation_data_dir = 'data/Activity Set 1/validation'
...
# Saving weight.
model.save_weights('output/KARD/Set1/DenseNet-190-40-KARD-Set1.h5')

from datetime import datetime
start=datetime.now()

datagen = ImageDataGenerator(rescale = 1./255)
generator = datagen.flow_from_directory('data/Activity Set 1/validation',
                                        target_size=(32, 32),
                                        batch_size=1,
...
plt.figure()
plot_confusion_matrix(cnf_matrix, classes =['Bend', 'Draw X', 'Forward Kick', 'Horizontal Arm Wave', 'Phone Call', 'Stand Up', 'Two Hand Wave', 'Walk'], normalize=True,
                      title='Confusion Matrix on KARD/Set1')

plt.savefig('output/KARD/Set1/Confusion-Matrix-DenseNet-190-40-KARD-Set1.png')
...
plt.title('DenseNet (L=190, k=40) on KARD/Action Set 1',fontsize=10, fontweight='bold',color = 'Gray')
...
# Save the figure.
plt.savefig('output/KARD/Set1/DenseNet-190-40-KARD-Set1.png')
plt.show()
